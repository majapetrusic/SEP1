...
public class FileIO
{
   ...
   // Reads the first object from the file with the given file name and returns
   // it.
   // Whoever calls the method will need to cast it from type Object to its real
   // type
   ...
   // Reads all objects from the file with the given file name and returns it as
   // an Object[].
